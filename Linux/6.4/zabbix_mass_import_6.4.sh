...
if ping -q -c 1 -W 1 raw.githubusercontent.com > /dev/null; then
  ...
  latest_version=$(wget -qO- https://raw.githubusercontent.com/bygalacos/Zabbix_Mass_Import/main/Linux/6.4/version.txt)
  ...
  if [ "$current_version" != "$latest_version" ]; then
	...
	changelog=$(wget -qO- https://raw.githubusercontent.com/bygalacos/Zabbix_Mass_Import/main/Linux/6.4/changelog.txt)
	printf "\nChangelog:\n$changelog\n\n"
    ...
    if [ "$update_confirm" = "y" ]; then
      ...
      wget -qO $0 https://raw.githubusercontent.com/bygalacos/Zabbix_Mass_Import/main/Linux/6.4/zabbix_mass_import_6.4.sh
