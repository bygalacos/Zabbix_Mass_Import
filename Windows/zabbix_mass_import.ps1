...
if (Test-Connection "raw.githubusercontent.com" -Count 1 -Quiet) {
  ...
  $latest_version = (Invoke-WebRequest -Uri "https://raw.githubusercontent.com/bygalacos/Zabbix_Mass_Import/main/Windows/version.txt").Content
  ...
  if ($current_version -ne $latest_version) {
    ...
    $changelog = (Invoke-WebRequest -Uri "https://raw.githubusercontent.com/bygalacos/Zabbix_Mass_Import/main/Windows/changelog.txt").Content
    ...
    if ($update_confirm -eq "y") {
      ...
      Invoke-WebRequest -Uri "https://raw.githubusercontent.com/bygalacos/Zabbix_Mass_Import/main/Windows/zabbix_mass_import.ps1" -OutFile $PSCommandPath
