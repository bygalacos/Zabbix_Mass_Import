...
if (Test-Connection "raw.githubusercontent.com" -Count 1 -Quiet) {
  ...
  $latest_version = (Invoke-WebRequest -Uri "https://raw.githubusercontent.com/bygalacos/Zabbix_Mass_Import/main/Windows/6.4/version.txt").Content
  ...
  if ($current_version -ne $latest_version) {
    ...
    $changelog = (Invoke-WebRequest -Uri "https://raw.githubusercontent.com/bygalacos/Zabbix_Mass_Import/main/Windows/6.4/changelog.txt").Content
    ...
    if ($update_confirm -eq "y") {
      ...
      Invoke-WebRequest -Uri "https://raw.githubusercontent.com/bygalacos/Zabbix_Mass_Import/main/Windows/6.4/zabbix_mass_import_6.4.ps1" -OutFile $PSCommandPath
